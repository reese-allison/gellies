...
function Axolotl(props){
    ...
    const RightEar = (attrs) => {
        return (
            <g style={attrs.style}>
                <path mask={`url(#body-mask-${ props.id })`} style="stroke:black;stroke-width:2px;stroke-opacity:1;" fill={`url(#moji-${ props.id }-body-color)`} d="m482.2 195-72.9 59.8-54.5-23.4 4.2-97.2 27.8 45.6 36.6-30.1 9.4 48.4z" />
                <path mask={`url(#body-mask-${ props.id })`} style={`stroke:url(#moji-${ props.id }-body-color);stroke-width:2px;stroke-opacity:.75;`} stroke-linejoin="round" d="m482.2 195-72.9 59.8-54.5-23.4 4.2-97.2 27.8 45.6 36.6-30.1 9.4 48.4z" />         
            </g>
        )
    }
    ...
    const LeftEar = (attrs) => {
        return (
            <g style={attrs.style}>
                <path mask={`url(#body-mask-${ props.id })`} style="stroke:black;stroke-width:2px;stroke-opacity:1;" fill={`url(#moji-${ props.id }-body-color)`} d="m3.9 198 72.9 59.8 54.5-23.4-4.2-97.2-27.8 45.6-36.6-30.1-9.4 48.4z" />
                <path mask={`url(#body-mask-${ props.id })`} style={`stroke:url(#moji-${ props.id }-body-color);stroke-width:2px;stroke-opacity:.75;`} stroke-linejoin="round" d="m3.9 198 72.9 59.8 54.5-23.4-4.2-97.2-27.8 45.6-36.6-30.1-9.4 48.4z" />
            </g>
        )
    }
