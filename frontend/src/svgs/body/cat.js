...
function Cat(props){
    ...
    const RightEar = (attrs) => {
        return (
            <g style={attrs.style}>
                <path mask={`url(#body-mask-${ props.id })`} style="stroke:black;stroke-width:2px;stroke-opacity:1;" fill={`url(#moji-${ props.id }-body-color)`} d="m 450.3,161.3 c -63.5,2.9 -83.5,18.5 -114.7,48.2 l 89.2,79.0 c 32.3,-49.3 36.8,-94.9 25.4,-127.2 z" />
                <path mask={`url(#body-mask-${ props.id })`} style={`stroke:url(#moji-${ props.id }-body-color);stroke-width:2px;stroke-opacity:.75;`} stroke-linejoin="round" d="m 450.3,161.3 c -63.5,2.9 -83.5,18.5 -114.7,48.2 l 89.2,79.0 c 32.3,-49.3 36.8,-94.9 25.4,-127.2 z" />    
            </g>
        )
    }
    ...
    const LeftEar = (attrs) => {
        return (
            <g style={attrs.style}>
              <path mask={`url(#body-mask-${ props.id })`} style="stroke:black;stroke-width:2px;stroke-opacity:1;" fill={`url(#moji-${ props.id }-body-color)`} d="m 32.2,164.0 c 63.5,2.9 83.5,18.5 114.7,48.2 L 57.7,291.3 C 25.3,242.0 20.8,196.4 32.2,164.0 Z" />
              <path mask={`url(#body-mask-${ props.id })`} style={`stroke:url(#moji-${ props.id }-body-color);stroke-width:2px;stroke-opacity:.75;`} stroke-linejoin="round" d="m 32.2,164.0 c 63.5,2.9 83.5,18.5 114.7,48.2 L 57.7,291.3 C 25.3,242.0 20.8,196.4 32.2,164.0 Z" />
            </g>
        )
    }
