...
export default (props) => {
    return (
        <g>
            <mask id={`body-mask-${ props.id }`}>
                <rect x="-50" y="-50" width="100%" height="100%" fill="white"></rect>
                <path fill="black" d="m114.5 214.3c65.4-39.5 183.5-45.7 264-2.1 60.1 36.8 96.7 107.2 77.6 172.2-9.9 44.1-48.5 76.5-92 85.2-70.2 18.2-173.3 15.9-240.2 4.8-42.5-8.2-82.2-38.8-93.6-89.8-21.9-64.7 16.5-132 84.1-170.2z" />
                <ellipse fill="black" cx="42.9" cy="200.4" rx="24.8" ry="24.4"></ellipse>
                <ellipse fill="black" cx="442.6" cy="193.7" rx="24.8" ry="24.4"></ellipse>
            </mask>
            <g id="moji-right-ear-{{ moji_id }}">
            ...
            <g id="moji-left-ear-{{ moji_id }}">
                <path mask={`url(#body-mask-${ props.id })`} fill={`url(#moji-${ props.id }-body-color)`} d="m 67.6,258.4 11.4,-4.1 C 111.2,183.7 72.9,165.4 45.5,198.8 l 1.0,8.6 c 37.4,-42.4 51.4,5.2 21.1,50.9 z" />
                <path mask={`url(#body-mask-${ props.id })`} style="fill:#000;fill-opacity:.25;stroke:black;stroke-width:.25px;stroke-opacity:1;" d="m 67.6,258.4 11.4,-4.1 C 111.2,183.7 72.9,165.4 45.5,198.8 l 1.0,8.6 c 37.4,-42.4 51.4,5.2 21.1,50.9 z" />
