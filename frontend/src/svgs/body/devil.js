...
function Devil(props){
    ...
    const RightEar = (attrs) => {
        return (
            <g style={attrs.style}>
                <path mask={`url(#body-mask-${ props.id })`} style="stroke:black;stroke-width:2px;stroke-opacity:1;" fill={`url(#moji-${ props.id }-body-color)`} d="m 387.8,227.6 c 17.5,18.6 35.1,37.2 52.7,55.8 23.7,-24.0 36.8,-59.9 29.2,-93.5 -4.2,-18.8 -20.1,-32.7 -37.5,-39.4 -15.7,-6.6 -32.7,-9.6 -48.5,-16.1 -7.1,0.2 3.5,5.9 5.5,7.4 13.6,9.8 28.7,19.8 36.0,35.7 4.0,11.3 -2.7,23.2 -10.3,31.4 -7.4,8.1 -16.3,15.5 -27.1,18.7 z" />
                <path mask={`url(#body-mask-${ props.id })`} style={`fill:#000;fill-opacity:.5;stroke:url(#moji-${ props.id }-body-color);stroke-width:2px;stroke-opacity:.35;`} d="m 387.8,227.6 c 17.5,18.6 35.1,37.2 52.7,55.8 23.7,-24.0 36.8,-59.9 29.2,-93.5 -4.2,-18.8 -20.1,-32.7 -37.5,-39.4 -15.7,-6.6 -32.7,-9.6 -48.5,-16.1 -7.1,0.2 3.5,5.9 5.5,7.4 13.6,9.8 28.7,19.8 36.0,35.7 4.0,11.3 -2.7,23.2 -10.3,31.4 -7.4,8.1 -16.3,15.5 -27.1,18.7 z" />
    ...
    const LeftEar = (attrs) => {
        return (
            <g style={attrs.style}>
                <path mask={`url(#body-mask-${ props.id })`} style="stroke:black;stroke-width:2px;stroke-opacity:1;" fill={`url(#moji-${ props.id }-body-color)`} d="M 99.9,230.6 C 82.3,249.2 64.7,267.9 47.1,286.5 23.3,262.4 10.3,226.5 17.8,192.9 c 4.2,-18.8 20.1,-32.7 37.5,-39.4 15.7,-6.6 32.7,-9.6 48.5,-16.1 7.1,0.2 -3.5,5.9 -5.5,7.4 -13.6,9.8 -28.7,19.8 -36.0,35.7 -4.0,11.3 2.7,23.2 10.3,31.4 7.4,8.1 16.3,15.5 27.1,18.7 z" />
                <path mask={`url(#body-mask-${ props.id })`} style={`fill:#000;fill-opacity:.5;stroke:url(#moji-${ props.id }-body-color);stroke-width:2px;stroke-opacity:.35;`} d="M 99.9,230.6 C 82.3,249.2 64.7,267.9 47.1,286.5 23.3,262.4 10.3,226.5 17.8,192.9 c 4.2,-18.8 20.1,-32.7 37.5,-39.4 15.7,-6.6 32.7,-9.6 48.5,-16.1 7.1,0.2 -3.5,5.9 -5.5,7.4 -13.6,9.8 -28.7,19.8 -36.0,35.7 -4.0,11.3 2.7,23.2 10.3,31.4 7.4,8.1 16.3,15.5 27.1,18.7 z" />
