...
export default (props) => {
    return (
        <g>
            <defs>
                <clipPath id={`cat-eye-left-clip-${ props.id }`}>
                    <ellipse cx="124.3" cy="328.9" rx="49.4" ry="54.8"/>
                </clipPath>
                <clipPath id={`cat-eye-right-clip-${ props.id}`}>
            ...
            <g>    
                ...
                <g clip-path={`url(#cat-eye-left-clip-${ props.id})`}>
                    <g class="inner-eye">
            ...
            <g>
                ...
                <g clip-path={`url(#cat-eye-right-clip-${ props.id})`}>
                    <g class="inner-eye">
