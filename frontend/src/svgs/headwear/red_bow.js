...
const RedBow = forwardRef((props, ref) =>{
    return (
        <g>
            {props.orientation === 'back' ? 
            <g>
                <g ref={ref}>
