...
class BlueBow extends PureComponent{
    constructor(props){
        super(props);
            ...
            <g ref={ this.ref }>
                <g style={ this.state.style }>
                    <linearGradient id={`moji-${ this.state.id }-headwear-color`} x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" style="stop-color:rgb(0,200,200);stop-opacity:1" />
                        <stop offset="50%" style="stop-color:rgb(0,240,240);stop-opacity:1" />
                        <stop offset="100%" style="stop-color:rgb(0,200,200);stop-opacity:1" />
                    </linearGradient>
...
export {
    BlueBow as Headwear, willRenderFront, willRenderBack
};
