            ...
            <g ref={this.ref}>
                <g style={this.state.style}>
                    <linearGradient id={`moji-${ this.state.id }-headwear-color`} x1="0%" y1="0%" x2="100%" y2="0%">
                        ...
                        <stop offset="50%" style="stop-color:rgb(240,0,0);stop-opacity:1" />
                    ...
                    <g id={`moji-${ this.state.id }-headwear`}>
                        ...
                        <path fill="#800000" style="stroke: #000;stroke-width:.2;" d="m 229,176.6 c -5.7,-11.3 -23.5,-33.9 -32.7,-33.9 -6.9,0 -13.6,19.3 -13.6,40.6 0,21.2 6,40.6 13.4,40.6 8.7,0 30.3,-14.4 30.3,-14.4 12.9,3.5 17.3,4.6 29.2,0.9 1.9,2.9 21.7,16.3 31.4,16.3 7.4,0 13.4,-19.3 13.4,-40.6 0,-21.2 -6.7,-40.6 -13.6,-40.6 -11.9,3.4 -28.6,21.6 -34.0,31.8 -7.3,-3.2 -14.7,-3.2 -23.9,-0.7 z" />
